...
const Home = () => {
  return (
    <div>
      <div className='bg-cover bg-center bg-[url("https://plus.unsplash.com/premium_vector-1721833865067-e6346760ba31?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")] h-screen pt-8 flex justify-between flex-col w-full bg-red-400'>
